...
export default function SearchResult(props) {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            try {
                ...
                const response = await fetch(`/api/get/${lowerCaseType}?${lowerCaseType}=${selectedSearchItemSymbol.symbol}`, { signal: controller.signal });
    ...
    }, [selectedSearchItemSymbol, props.searchAssetType, props.usdToINR])
